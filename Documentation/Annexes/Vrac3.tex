...
Elle est utilisée par les foncteurs ayant un tres grand nombre d'inconnues
...
\begin{comment}
\item {\tt Mascarpone} computes a mask using normal directions and then runs a graph-cut to get smoother region
\end{comment}
...
\end{verbatim}
For more information on Misha Khazdan's code: \href{http://www.cs.jhu.edu/~misha/Code/PoissonRecon/}{http://www.cs.jhu.edu/~misha/Code/PoissonRecon/}
