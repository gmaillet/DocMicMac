...
Possible error: Not enough samples (Min 3) in cRansacBasculementRigide. It means that there is not enough points to compute a Bascule  transform. You should add more points with SaisieAppuisInit
