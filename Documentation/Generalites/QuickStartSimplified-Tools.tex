...
can be used to merge the two orientation.
...
Now we want to merge this two orientation, taking benefit that images {\tt IMG\_0240.jpg \dots IMG\_0249.jpg} are common to the two subset. We use :

\begin{verbatim}
mm3d Morito Ori-48/Orientation-Abbey-IMG_02.*xml  Ori-04/Orientation-Abbey-IMG_02.*xml 08
\end{verbatim}

The merged orientation are in {\tt Ori-48/}, the programm has estimated a $3d$ similitude ($7$ parameter) to do the merging. The merging is done in the system of the first set of images.  As the system is redundant, the residual can be used as estimation of the accuracy. They are printed by {\tt Morito} , the {\tt DMatr} represent the residual in rotation and {\tt DPt} the residual in center :
