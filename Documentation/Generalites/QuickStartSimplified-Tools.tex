...
"just in case". For now, there is no way to avod this mecanism, but if it happens to have unwanted side effect,
...
If the tag {\tt <BayPat>} is present the image is interpreted as a colour image acquired by bayer matrix 
