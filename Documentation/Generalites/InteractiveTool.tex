...
Example: \begin{verbatim} mm3d SaisieMasqQT IMG.tif SzW=[1200,800] Name=PLAN Gama=1.5 \end{verbatim}\\*
...
\item 3: {\tt SaisieMasqQT } can display ply files and camera orientation files
