...
\begin{itemize}
   ...
   \item Isabelle Clery, Aymeric Godet and Livio de Luca for  developing two different user friendly interfaces and also making many tests,
...
\begin{itemize}
   ...
   \item    image magick for convert, for using jpg images (http://www.imagemagick.org/);
   \item    proj4 for handling cartographic projection (http://trac.osgeo.org/proj/) ;
\end{itemize}
...
\begin{itemize}
   \item "http://jmfriedt.free.fr/lm\_sfm\_eng.pdf" by JM Friedt;
   \item "http://forum-micmac.forumprod.com/bibliography-f38.html"  a section of the forum dedicated to bibliography;
   \item several document in the {\tt Documentation} folder and sub folder of MicMac distribution (see in
         particular {\tt pdf} file 
         and {\tt Paper-Algo/ , Paper-MPD/ , Papers-Internship/ , Paper-UseCase/} sub folder)
   \item "http://combiencaporte.blogspot.fr/2013/10/micmac-tutoriel-de-photogrammetrie-sous.html" 
\end{itemize}
...
These softwares have few dependencies to others libraries or programs. Basically,
