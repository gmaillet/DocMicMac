...
\begin{verbatim}
mm3d SateLib Dimap2Grid dimapFile imageFile altitudeMin altitudeMax nbLayers
mm3d Tapioca All imagesPattern -1
mm3d SateLib RefineModel image_1.GRI image_2.GRI pts_1_2.dat meanAltitude
mm3d SateLib Dimap2Grid dimapFile imageFile altMin altMax nbLay refineCoef=refine/refineCoef.txt
\end{verbatim}
...
Named args :
  * [Name=targetSyst] string :: {target system in Proj4 format}
