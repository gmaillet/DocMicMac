...
%=======================================================================================================
\section{Recent evolution in Tapas}

This section describes option which, at the time being are implemented in a temporary tool name {\tt NewTapas}. However,
in a near future , when  {\tt NewTapas} will have been validated by beta-tester, it will replace Tapas (with 
a full compatibility of command but with result slightly different).
...
The firts one is accessible directly in {\tt NewTapas}, not the second. Buth both are accessible as additional distortion.
