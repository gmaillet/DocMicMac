...
%=======================================================================================================
\section{Changing default detector}


There exist different implemantation of Sift detector and Ann matchor. The newest one offer
more option, while the oldest have been more tested \dots 

To change, this default you must edit your {\tt MM-Environment.xml} in the folder {\tt include/XML\_User/}.
For example :
...
%=======================================================================================================
\section{Filtering tie points}


The commande {\tt HomolFilterMasq} can do some filtering on tie points. The masqing
