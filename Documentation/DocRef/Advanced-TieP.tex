...
Named args : 
  ...
  * [Name=ExpTxt] bool :: {Ascii format for in and out, def=false}
  * [Name=ShowEvo] bool :: {Show Packs evolution, def=false}
\end{verbatim}
...
It also checks that each couple of points appears in the packs 2-way (image1/image2.pac and image2/image1.pac).
